            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
                <div class="p-5 sm:p-6 text-gray-900">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                        ...
                        <a href="{{ route('dokter.export.excel.all') }}" class="inline-flex items-center px-4 py-2.5 bg-accent-500 text-white hover:bg-accent-600 border border-transparent rounded-lg text-sm font-bold transition-all duration-200 shadow-sm hover:shadow-md whitespace-nowrap">
