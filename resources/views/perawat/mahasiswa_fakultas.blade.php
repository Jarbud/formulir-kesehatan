                                ...
                                @forelse($pemeriksaans as $item)
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ route('perawat.mahasiswa.detail', $item->user_id) }}" class="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 rounded-md text-xs font-bold transition">
                                                Detail Mahasiswa
                                            </a>
                                        </td>
                                    </tr>
