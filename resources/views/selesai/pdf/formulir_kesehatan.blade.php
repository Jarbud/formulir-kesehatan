...
<body>
    ...
    <table class="form-table" style="margin-top: 0;">
        ...
        <tr>
            ...
            <td class="col-value"><u>{{ $data->tekanan_darah }}</u> mmHg</td>
        </tr>
        <tr>
            ...
            <td class="col-value">
                @if($data->ishihara == '-')
                    <strong>( - )</strong>
                @elseif($data->ishihara == '+')
                    <strong>( + )</strong>
                @elseif($data->ishihara == 'parsial')
    ...
    <div>
        ...
        <span style="{{ $data->kesimpulan != 'Layak' ? 'text-decoration: line-through; color: #6c757d;' : 'font-weight: bold;' }}">Layak</span> / 
        
        <span style="{{ $data->kesimpulan != 'Layak dengan Syarat' ? 'text-decoration: line-through; color: #6c757d;' : 'font-weight: bold;' }}">Layak Dengan Syarat</span> / 
        
        <span style="{{ $data->kesimpulan != 'Tidak Layak Mengikuti PKKMB' ? 'text-decoration: line-through; color: #6c757d;' : 'font-weight: bold;' }}">Tidak Layak Mengikuti PKKMB</span>
    ...
    <table class="ttd-table">
        <tr>
            ...
            <td style="text-align: right; padding-right: 50px; vertical-align: top;">
                ...
                Dokter Pemeriksa
                <div style="margin-top: 10px; margin-bottom: 10px;">
                    @if($data->id_dokter_acc)
                        <img src="data:image/svg+xml;base64,{!! base64_encode(QrCode::size(70)->generate(route('validasi.nakes', $data->id_dokter_acc))) !!}" width="70" height="70">
                    @else
                        <div class="ruang-ttd"></div>
                    @endif
                </div>
                ( <u>{{ $data->id_dokter_acc ? $data->dokter->name : '..................................................' }}</u> )
                @if($data->id_dokter_acc && $data->dokter->nip)
                    <br>NIP. {{ $data->dokter->nip }}
                @endif
            </td>
        </tr>
    </table>
